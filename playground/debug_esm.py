...
def main():
    ...
    model_esm_sdpa = EsmModel.from_pretrained("facebook/esm2_t6_8M_UR50D").to(device)
    model_esm_eager = EsmModel.from_pretrained("facebook/esm2_t6_8M_UR50D").to(device)
